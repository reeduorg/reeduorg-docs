...
We take Security seriously, so if you have discovered a security risk report it by email to [kiko@reedu.org](mailto:kiko@reedu.org) preferably using end-to-end encrypted messages with the following PGP key: [0x70c7d0901133471df2e6e9a8006c13a68e25d3b7](https://keyserver.ubuntu.com/pks/lookup?op=get&search=0x70c7d0901133471df2e6e9a8006c13a68e25d3b7).
